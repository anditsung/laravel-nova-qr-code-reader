...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-qr-code-reader', __webpack_require__(5));
    Vue.component('detail-qr-code-reader', __webpack_require__(12));
    Vue.component('form-qr-code-reader', __webpack_require__(15));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_qrcode_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_qrcode_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_qrcode_component__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { VueQRCodeComponent: __WEBPACK_IMPORTED_MODULE_0_vue_qrcode_component___default.a },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_qrcode_js_package_qrcode_js__ = __webpack_require__(8);
      ...
      ? _c(
          ...
          [
            _c(
              ...
              [
                _vm.field.value
                  ? _c("vue-q-r-code-component", {
                      attrs: { text: _vm.field.value, size: _vm.qrSizeIndex }
                    })
                  : _vm._e()
              ],
              1
        ...
        ? _c("div", { staticClass: "flex" }, [
            _c(
              ...
              [
                _vm.fieldValue
                  ? _c("vue-q-r-code-component", {
                      attrs: { text: _vm.fieldValue, size: _vm.qrSizeDetail }
                    })
                  : _vm._e()
              ],
              1
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CameraCaptureModal__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CameraCaptureModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__CameraCaptureModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_qrcode_component__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { CameraCaptureModal: __WEBPACK_IMPORTED_MODULE_0__CameraCaptureModal___default.a, VueQRCodeComponent: __WEBPACK_IMPORTED_MODULE_1_vue_qrcode_component___default.a },
    ...
    methods: {
        scanData: function scanData(decodedString) {
...
Component.options.__file = "resources/js/components/CameraCaptureModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5dbd0a77", Component.options)
  } else {
    hotAPI.reload("data-v-5dbd0a77", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_qrcode_reader__ = __webpack_require__(22);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                ...
                                _context.next = _context.t1 === "NotAllowedError" ? 11 : _context.t1 === "NotFoundError" ? 13 : _context.t1 === "NotSupportedError" ? 15 : _context.t1 === "NotReadableError" ? 17 : _context.t1 === "OverconstrainedError" ? 19 : _context.t1 === "StreamApiNotSupportedError" ? 21 : 23;
                                break;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dist_vue_qrcode_reader_css__ = __webpack_require__(24);
                ...
                ? _c("div", { staticClass: "border-b border-40" }, [
                    _c("div", { staticClass: "py-6 px-8 w-full" }, [
                      _c("input", {
                        ...
                        staticClass:
                          "w-full form-control form-input form-input-bordered text-center",
                      ...
                      _vm.hasError
                        ? _c(
                            ...
                            [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(_vm.__(this.errorMessage)) +
                                  "\n                    "
                              )
                            ]
                          )
                          ...
                          _vm.cameraError
                            ? _c(
                                ...
                                [
                                  _vm._v(
                                    "\n                            " +
                                      _vm._s(_vm.__(this.cameraErrorMessage)) +
                                      "\n                        "
                                  )
                                ]
                              )
            ...
            _c("div", { staticClass: "flex items-center ml-auto" }, [
              _c(
                "button",
                {
                  ...
                  attrs: { dusk: "cancel-button", type: "button" },
                  on: {
              ...
              _c(
                "button",
                {
                  ...
                  attrs: { dusk: "capture-button", type: "submit" }
                },
                [
                  _vm.working
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5dbd0a77", module.exports)
  }
}
    ...
    [
      _c(
        ...
        [
            ...
            [
              !_vm.canInput
                ? _c("vue-q-r-code-component", {
                    ...
                    attrs: { text: _vm.value, size: _vm.qrSizeForm }
                  })
                : _c("div", [
                    _c("input", {
                      directives: [
          ...
          _vm._v(" "),
          _vm.showModal
            ? _c("camera-capture-modal", {
                attrs: {
                  displayWidth: _vm.displayWidth,
