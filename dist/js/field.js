              ...
              [
                _vm.field.value
                  ? _c("vue-q-r-code-component", {
                      attrs: { text: _vm.field.value, size: 30 }
                    })
                  : _vm._e()
              ],
              1
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      ...
      [
        _vm.fieldValue
          ? _c("vue-q-r-code-component", {
              attrs: { text: _vm.fieldValue, size: _vm.qrSize }
            })
          : _vm._e()
      ],
      1
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(27);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_qrcode_reader__ = __webpack_require__(19);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dist_vue_qrcode_reader_css__ = __webpack_require__(21);
        ...
        [
            ...
            [
              _vm.canInput
                ? _c("vue-q-r-code-component", {
                    ...
                    attrs: { text: _vm.value, size: _vm.qrSize }
                  })
                : _c("div", [
                    _c("input", {
                      directives: [
          ...
          _vm.showModal
            ? _c("camera-capture-modal", {
                attrs: { showSubmit: _vm.showSubmit },
                on: {
